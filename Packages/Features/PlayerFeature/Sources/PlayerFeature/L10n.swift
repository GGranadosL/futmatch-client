...
public enum L10n {
    ...
    public enum ErrorOverlay {
        ...
        /// Generic message for the full-screen error state (no cache + load failed).
        public static var fullScreenMessage: String {
            NSLocalizedString("error.fullScreen.message", bundle: .module, comment: "")
        }
        /// Toast message when a refresh fails but cached content is still shown.
        public static var refreshMessage: String {
            NSLocalizedString("error.refresh.message", bundle: .module, comment: "")
        }
    }
    ...
    public enum Payment {
        ...
        public static var confirming: String {
            NSLocalizedString("payment.confirming", bundle: .module, comment: "")
        }
    }
